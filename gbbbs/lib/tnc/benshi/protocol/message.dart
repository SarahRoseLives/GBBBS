    ...
    if (commandGroup == CommandGroup.EXTENDED) {
      ...
      switch (cmd) {
        ...
        case BasicCommand.WRITE_RF_CH:
            parsedBody = isReply ? WriteRFChReplyBody.fromBytes(bodyBytes) : WriteRFChBody(rfCh: Channel.fromBytes(bodyBytes));
            break;
        ...
        case BasicCommand.HT_SEND_DATA:
          parsedBody = isReply ? HTSendDataReplyBody.fromBytes(bodyBytes) : HTSendDataBody(tncDataFragment: TncDataFragment.fromBytes(bodyBytes));
          break;
        default:
          parsedBody = UnknownBody(data: bodyBytes);
      }
