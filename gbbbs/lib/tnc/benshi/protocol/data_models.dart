...
class TncDataFragment {
  ...
  Uint8List toBytes() {
    final writer = ByteWriter(1 + data.length + (withChannelId && channelId != null ? 1 : 0));
    writer.writeBool(isFinalFragment);
    writer.writeBool(withChannelId);
    writer.writeInt(fragmentId, 6);
    writer.writeBytes(data);
    if (withChannelId && channelId != null) {
        writer.writeInt(channelId!, 8);
    }
    return writer.toBytes();
  }
